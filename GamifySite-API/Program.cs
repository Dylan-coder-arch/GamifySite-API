...
using GamifySite_API.Repository.TagRepo;
using GamifySite_API.Repository.PaymentRepo;
using GamifySite_API.Repository.SpinWinnerRepo;
...
builder.Services.AddScoped<ISpinWinnerRepository, SpinWinnerRepo>();
